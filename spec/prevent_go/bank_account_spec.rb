RSpec.describe PreventGo::BankAccount do
  describe '.new' do
    context 'with only a valid file', cassette: :bank_account_valid do
      ...
      it 'should instanciate an object' do
        ...
        expect(instance.document_type).to eq('RIB')
      end
    end
  end

  describe 'instance methods', cassette: :bank_account_valid do
